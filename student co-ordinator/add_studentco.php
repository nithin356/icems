	...
	if($password == $repassword)
		{
			...
			$usersql="SELECT * FROM `std_co` WHERE username='$username'";
			$checkuser=mysqli_query($connection, $usersql);
			$countu=mysqli_num_rows($checkuser);
			$emailsql="SELECT * FROM `std_co` WHERE email='$email'";
                        ...
                        <div class="white-box">
                            ...
                            <form data-toggle="validator" method="post">
                               <?php if(isset($fmsg)) { ?>
								...
								<div class="form-group">
                                    <label for="inputEmail" class="control-label">College Name</label>
                                    <input name="college" type="text" class="form-control" id="inputEmail" placeholder="Enter your email" data-error="This email address is invalid" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group">

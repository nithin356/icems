    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="tables.html" class="waves-effect active"><i class="zmdi zmdi-border-all zmdi-hc-fw fa-fw"></i> <span class="hide-menu">Tables<span class="fa arrow"></span><span class="label label-rouded label-danger pull-right">7</span></span></a>
                        <ul class="nav nav-second-level">
            ...
            <div class="container-fluid">
												...
												{ ?>
															<tr> 
																...
																<td class="text-nowrap">
																	<a href="edit.php?id=<?php echo $result["a_id"]; ?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
																	<a data-toggle="tooltip" data-original-title="Delete" alt="alert" id="sa-params" href="#"><i class="fa fa-close text-danger"></i> </a>
																</td> 
															</tr>
										<?php 
												}
				...
				<div class="col-lg-4 col-xs-12">
                        <div class="white-box">
                            ...
                            <img src="../plugins/images/alert5.png" alt="alert" class="img-responsive model_img" id="sa-params">
						</div>
                </div>

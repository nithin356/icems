    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li> <a href="index.html" class="waves-effect"><i class="zmdi zmdi-view-dashboard zmdi-hc-fw fa-fw" ></i> <span class="hide-menu"> Dashboard <span class="fa arrow"></span> <span class="label label-rouded label-custom pull-right">4</span></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li> <a href="#" class="waves-effect active"><i class="zmdi zmdi-copy zmdi-hc-fw fa-fw"></i> <span class="hide-menu">Sample Pages<span class="fa arrow"></span><span class="label label-rouded label-purple pull-right">30</span></span></a>
                        <ul class="nav nav-second-level">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li><a href="admin_table.php">Admin Table</a></li>
				...
				<?php
								...
								require('connect.php');
									...
									$sql = "SELECT username, email, password FROM admin WHERE a_id='$id'";
									...
									if (isset($_POST['username']) && isset($_POST['email']))
									{
										...
										$query="UPDATE admin SET username='$newuname', email='$newemail' WHERE a_id='$id'";
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="../plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="../plugins/images/users/agent.jpg" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white"><?php echo"$uname"; ?></h4>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav customtab nav-tabs" role="tablist">
                                <li role="presentation" class="nav-item"><a href="#settings" class="nav-link" aria-controls="h" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="fa fa-cog"></i></span> <span class="hidden-xs">Setting</span></a></li>
                            </ul>
                                ...
                                <div class="tab-pane active" id="settings">
                                    ...
                                    <form class="form-horizontal form-material" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="username" value="<?php  echo"$uname"; ?>" class="form-control form-control-line" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email" class="col-md-12">Email</label>
                                            <div class="col-md-12">
                                                <input type="email" name="email" value="<?php echo"$email"; ?>" class="form-control form-control-line" id="example-email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="checkbox checkbox-info">
                                        <input id="checkbox1" type="checkbox" checked="true" class="fxhdr">
                                        <label for="checkbox1"> Fix Header </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox checkbox-warning">
                                        <input id="checkbox2" type="checkbox" checked="true" class="fxsdr">

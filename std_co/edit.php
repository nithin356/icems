            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Registered Participants</h4>
                    </div>
                    <!-- /.page title -->
                    <!-- .breadcrumb -->
                            ...
                            <div class="row">
                                  <div class="col-md-8 col-sm-8">
                                    ...
                                    <p>
                                      ...
                                      <i class="fa fa-edge"></i><?php echo $result['p_name1']; ?>
                  										<div class="p-t-5">
									  <i class="fa fa-edge"></i><?php echo $result['p_name2']; ?>
                  										<div class="p-t-5">
											<a href="edit-participant.php?id=<?php echo $result['p_id']; ?>" class="fcbtn btn btn-info">Edit</a>
